...
/***
 *
 * I stole this off of the internet, you don't need to do anything with this.
 * This isn't a part of the test, well, actually, if you read the comments, you're doing well.
 *
 */
class MorseCodeConverter {
    ...
    static final long GAP = 50;
    static final long LETTER_GAP = 50 * 3;
    static final long WORD_GAP = 50 * 7;
